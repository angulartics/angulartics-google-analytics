...
.config(['$analyticsProvider', function ($analyticsProvider) {
  ...
  /**
   * Retrieves the Universal Analytics namespace for the GA global
   * Uses the GoogleAnalyticsObject property set by the default GA snippet
   * Defaults to 'ga' if not set (as in the alternate async snippet)
   *
   * @name getUniversalAnalyticsNamespace
   * @returns {string} The name of the GA global
   */
  function getUniversalAnalyticsNamespace() {
  ...
  function detectUniversalAnalytics() {
    ...
    var gaNamespace = getUniversalAnalyticsNamespace();
    return window[gaNamespace];
